...
export default function StatsBar({ downloads = "1.2k+", version = "v1.0.1" }: { downloads?: string, version?: string }) {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg, #050505 0%, #080a09 100%)",
      }}
    >
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {displayStats.map((stat, i) => (
            ...
            >
              <div className="text-emerald-500/60 group-hover:text-emerald-400 transition-colors duration-300">
                {stat.icon}
              </div>
              <div>
                ...
                <div className="text-neutral-500 text-[11px] uppercase tracking-[0.15em] font-medium">
                  {stat.label}
                </div>
              </div>
            </motion.div>
